...
public class XLSEventModel extends EventModel implements HSSFListener {
	 ...
	 */
	public XLSEventModel(POIFSFileSystem fs, int startRow, Consumer<List<String>> readConsumer) {
	 ...
	 * @throws IOException
	 */
	public XLSEventModel(InputStream stream,int startRow,Consumer<List<String>> readConsumer) throws IOException{
	 ...
	 * @throws IOException
	 */
	public XLSEventModel(InputStream stream,Consumer<List<String>> readConsumer) throws IOException{
