...
public class ReadTest {
    ...
    /**
     * 由于空cell造成监听函数——readFunction出现"数组越界"或"索引乱序"问题。<br>
     * <a href="https://github.com/liuhuagui/gridexcel/issues/3">Issue #3</a><br
     * <a href="https://github.com/liuhuagui/gridexcel/issues/4">Issue #4</a><br>
     * <a href="https://github.com/liuhuagui/gridexcel/issues/5">Issue #5</a><br>
     * 测试XlsxByEventModel
     *
     * @throws Exception
     */
...
//                    System.out.println(cs.size());
     ...
     */
    @Test
    public void readMissingCellXlsxByUserModel() throws Exception {
        InputStream resourceAsStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("test.xlsx");
        GridExcel.readByUserModel(resourceAsStream, Map.class, ExcelType.XLSX)
                .window(2, ts -> System.out.println(ts.size()))//推荐在这里执行自己的业务逻辑
                .process(row -> {
//                    System.out.println(row.getLastCellNum());
     ...
     */
    @Test
    public void readMissingCellXlsByUserModel() throws Exception {
        InputStream resourceAsStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("test.xls");
        GridExcel.readByUserModel(resourceAsStream, Map.class, ExcelType.XLS)
                .window(2, ts -> System.out.println(ts.size()))//推荐在这里执行自己的业务逻辑
                .process(row -> {
//                    System.out.println(row.getLastCellNum());
                    return null;
